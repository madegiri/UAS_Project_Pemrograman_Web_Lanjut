...
<section class="shopping-cart">
   ...
   <div class="box-container">
      ...
      ?>
      <div class="box">
         <a href="cart.php?delete=<?php echo $fetch_cart['id']; ?>" class="fas fa-times" onclick="return confirm('Hapus barang ini dari keranjang?');"></a>
         ...
         <div class="sub-total"> Total Harga : <span>Rp<?php echo number_format($sub_total, 0, ',', '.') ; ?></span> </div>
      </div>
      <?php
   ...
   <div style="margin-top: 2rem; text-align:center;">
      <a href="cart.php?delete_all" class="delete-btn <?php echo ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('Hapus semua barang dari keranjang?');">Hapus Semua</a>
   </div>
