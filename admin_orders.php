...
if(isset($_POST['update_order'])){
   ...
   $message[] = 'Status Pembayaran Sudah di Update!';
...
<section class="orders">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p> Nama Pemesan : <span><?php echo $fetch_orders['name']; ?></span> </p>
         <p> No Telepon : <span><?php echo $fetch_orders['number']; ?></span> </p>
         ...
         <form action="" method="post">
            ...
            <a href="detail_pesanan_admin.php?id=<?php echo $fetch_orders['id']; ?>" class="detail-btn">Detail</a>
         </form>
      </div>
      <?php
         }
